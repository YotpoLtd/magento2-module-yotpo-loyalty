    ...
    public function execute(Observer $observer)
    {
        try {
            ...
            if ($response->getError()) {
                ...
                $this->yotpoHelper->log("[Observer\Config\BaseUrlChanged] Successfully sent store information webhhok.", "info");
            }
        } catch (\Exception $e) {
            $this->yotpoHelper->log("[Observer\Config\BaseUrlChanged - ERROR] " . $e->getMessage() . "\n" . $e->getTraceAsString(), "error");
        }
